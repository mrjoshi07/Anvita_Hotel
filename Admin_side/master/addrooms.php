              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col2">
                     ...
                     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col3">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col13">
                                   ...
                                   <form action="../savepages/addroomsave.php" method="POST" role="form">

                                           <h3 style="text-align: center">Create User-Type</h3>

                                           <?php
                                                 $sql="select max(id) from tblrooms";
                                          ...
                                          <div class="form1">
                                                  <input type="text" class="form1" id="txtroom" name="txtroom" placeholder="Room-Name" autocomplete="off" require>
                                          </div>

                                          <button type="submit" name="btnroomsave"
